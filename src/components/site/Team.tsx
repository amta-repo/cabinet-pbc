...
const team = [
  { img: t1, name: "Philippe Larsen", role: "Architecte en Chef" },
  { img: t2, name: "Aïcha Diallo", role: "Ingénieure Structure" },
  { img: t3, name: "Marc Bertrand", role: "Chef de Projet" },
  { img: t4, name: "Hélène Moreau", role: "Designer d'Intérieur" },
];

const Team = () => {
  return (
    <section id="equipe" className="relative bg-navy-light py-24 md:py-32">
